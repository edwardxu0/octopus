...
# train_nodes_ex = "jaguar06,jaguar05,sds01,sds02"#
train_nodes_ex = "lynx01,lynx12,jaguar02,jaguar01,cheetah01,jaguar03,jaguar04,jaguar05,cheetah02,jaguar06,sds01"
...
# epsilons = np.linspace(2, 100, 50) / 10000  # test
epsilons = np.linspace(18, 26, 5) / 10000  # real

print(f"seeds: |{len(seeds)}|, props: |{len(props)}|")
print(f"epsilons: |{len(epsilons)}|, {epsilons}")

# verifiers = ["SH:abcrown2"]
