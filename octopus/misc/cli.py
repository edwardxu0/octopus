...
def _parse_args():
    ...
    parser.add_argument(
        "--log_path", type=str, default="./logs", help="default reuslt path for logging"
    )
    parser.add_argument(
        "--meta_path",
        type=str,
    ...
    parser.add_argument(
        "--adv_train", type=str, default="nature", help="adversarial training option"
    )
    # pruning params
    parser.add_argument(
        "--pr_ratio", type=float, default=0.2, help="pruning ratio : (default: 0.2)"
    )
    ...
    parser.add_argument(
        "--rurh_ocrc", type=float, default=None, help="rurh occurance(%%)."
    )
    parser.add_argument(
        "--rurh_itst", type=int, default=None, help="rurh intensity(%%)."
    )
    parser.add_argument(
        "--rurh_upbd", type=int, default=None, help="rurh upper bound(%%)."
    )
    parser.add_argument(
        "--rurh_ral", type=float, default=None, help="rurh relative accuracy loss(%%)."
    )
    parser.add_argument(
        "--rurh_deactive_pre",
        type=int,
